...
Route::group(['prefix' => 'api'], function () {
    ...
    Route::group(['prefix' => 'admin', 'middleware' => 'admin'], function () {
        ...
        Route::group(['prefix' => 'repair'], function () {
            Route::get('view/{type}/{start}/{end}', 'Admin\Repair\ViewController@data');
        ...
        Route::group(['prefix' => 'part'], function () {
            Route::get('use', 'Admin\Part\UseController@data');
            Route::get('add', 'Admin\Part\NumberController@data');
            Route::post('number', 'Admin\Part\NumberController@add');
